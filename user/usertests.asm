...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	11250513          	add	a0,a0,274 # 6150 <malloc+0x10c>
      ...
      74:	8082                	ret
{
      ...
      84:	0f050513          	add	a0,a0,240 # 6170 <malloc+0x12c>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0e050513          	add	a0,a0,224 # 6188 <malloc+0x144>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0e250513          	add	a0,a0,226 # 61a8 <malloc+0x164>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0aa50513          	add	a0,a0,170 # 6190 <malloc+0x14c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0b650513          	add	a0,a0,182 # 61b8 <malloc+0x174>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0b450513          	add	a0,a0,180 # 61e0 <malloc+0x19c>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0a050513          	add	a0,a0,160 # 61e0 <malloc+0x19c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	09c58593          	add	a1,a1,156 # 61f0 <malloc+0x1ac>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	07850513          	add	a0,a0,120 # 61e0 <malloc+0x19c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	07c58593          	add	a1,a1,124 # 61f8 <malloc+0x1b4>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	04c50513          	add	a0,a0,76 # 61e0 <malloc+0x19c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	03650513          	add	a0,a0,54 # 6200 <malloc+0x1bc>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fac50513          	add	a0,a0,-84 # 6228 <malloc+0x1e4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f98a8a93          	add	s5,s5,-104 # 6228 <malloc+0x1e4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f2650513          	add	a0,a0,-218 # 6238 <malloc+0x1f4>
     ...
     338:	f2450513          	add	a0,a0,-220 # 6258 <malloc+0x214>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f1250513          	add	a0,a0,-238 # 6270 <malloc+0x22c>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	efe98993          	add	s3,s3,-258 # 6270 <malloc+0x22c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	eb250513          	add	a0,a0,-334 # 6270 <malloc+0x22c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e2258593          	add	a1,a1,-478 # 61f8 <malloc+0x1b4>
    ...
    printf("write failed\n");
     ...
     3f0:	ea450513          	add	a0,a0,-348 # 6290 <malloc+0x24c>
    ...
    exit(1);
     ...
     40a:	e7250513          	add	a0,a0,-398 # 6278 <malloc+0x234>
    ...
    printf("open junk failed\n");
     ...
     424:	e5850513          	add	a0,a0,-424 # 6278 <malloc+0x234>
  ...
  unlink("junk");
     ...
     448:	e2c50513          	add	a0,a0,-468 # 6270 <malloc+0x22c>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d50a0a13          	add	s4,s4,-688 # 62a0 <malloc+0x25c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	cac50513          	add	a0,a0,-852 # 62a8 <malloc+0x264>
     ...
     61e:	ca650513          	add	a0,a0,-858 # 62c0 <malloc+0x27c>
     ...
     63c:	cb850513          	add	a0,a0,-840 # 62f0 <malloc+0x2ac>
     ...
     656:	cce50513          	add	a0,a0,-818 # 6320 <malloc+0x2dc>
     ...
     674:	cc050513          	add	a0,a0,-832 # 6330 <malloc+0x2ec>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	cb2a0a13          	add	s4,s4,-846 # 6360 <malloc+0x31c>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b42a8a93          	add	s5,s5,-1214 # 61f8 <malloc+0x1b4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c0c50513          	add	a0,a0,-1012 # 6368 <malloc+0x324>
     ...
     77e:	c0650513          	add	a0,a0,-1018 # 6380 <malloc+0x33c>
     ...
     798:	b8c50513          	add	a0,a0,-1140 # 6320 <malloc+0x2dc>
     ...
     7b2:	c0250513          	add	a0,a0,-1022 # 63b0 <malloc+0x36c>
     ...
     7d0:	bfc50513          	add	a0,a0,-1028 # 63c8 <malloc+0x384>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9ce58593          	add	a1,a1,-1586 # 61f0 <malloc+0x1ac>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	9a250513          	add	a0,a0,-1630 # 61e0 <malloc+0x19c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	97650513          	add	a0,a0,-1674 # 61e0 <malloc+0x19c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	96250513          	add	a0,a0,-1694 # 61e0 <malloc+0x19c>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b9c58593          	add	a1,a1,-1124 # 6458 <malloc+0x414>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8e250513          	add	a0,a0,-1822 # 61e0 <malloc+0x19c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	ab650513          	add	a0,a0,-1354 # 63f8 <malloc+0x3b4>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	aba50513          	add	a0,a0,-1350 # 6418 <malloc+0x3d4>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	ab650513          	add	a0,a0,-1354 # 6428 <malloc+0x3e4>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	aba50513          	add	a0,a0,-1350 # 6448 <malloc+0x404>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a8650513          	add	a0,a0,-1402 # 6428 <malloc+0x3e4>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	aa050513          	add	a0,a0,-1376 # 6460 <malloc+0x41c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	aa250513          	add	a0,a0,-1374 # 6480 <malloc+0x43c>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a8e50513          	add	a0,a0,-1394 # 64a0 <malloc+0x45c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a9e98993          	add	s3,s3,-1378 # 64c8 <malloc+0x484>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	acea8a93          	add	s5,s5,-1330 # 6500 <malloc+0x4bc>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a2850513          	add	a0,a0,-1496 # 64a0 <malloc+0x45c>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9ec50513          	add	a0,a0,-1556 # 64a0 <malloc+0x45c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9ca50513          	add	a0,a0,-1590 # 64a8 <malloc+0x464>
    ...
    exit(1);
     ...
     b00:	9dc50513          	add	a0,a0,-1572 # 64d8 <malloc+0x494>
     ...
     b1e:	9f650513          	add	a0,a0,-1546 # 6510 <malloc+0x4cc>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a0250513          	add	a0,a0,-1534 # 6538 <malloc+0x4f4>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a0650513          	add	a0,a0,-1530 # 6558 <malloc+0x514>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a0250513          	add	a0,a0,-1534 # 6570 <malloc+0x52c>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9f050513          	add	a0,a0,-1552 # 6590 <malloc+0x54c>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	99e50513          	add	a0,a0,-1634 # 6590 <malloc+0x54c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	95e50513          	add	a0,a0,-1698 # 6598 <malloc+0x554>
    ...
    exit(1);
     ...
     c5c:	96050513          	add	a0,a0,-1696 # 65b8 <malloc+0x574>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	96c50513          	add	a0,a0,-1684 # 65e0 <malloc+0x59c>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8f050513          	add	a0,a0,-1808 # 6590 <malloc+0x54c>
     ...
     cd0:	93450513          	add	a0,a0,-1740 # 6600 <malloc+0x5bc>
     ...
     cee:	93e50513          	add	a0,a0,-1730 # 6628 <malloc+0x5e4>
     ...
     d0c:	93850513          	add	a0,a0,-1736 # 6640 <malloc+0x5fc>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	94450513          	add	a0,a0,-1724 # 6668 <malloc+0x624>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	92e50513          	add	a0,a0,-1746 # 6680 <malloc+0x63c>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	94658593          	add	a1,a1,-1722 # 66b0 <malloc+0x66c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8fa50513          	add	a0,a0,-1798 # 6680 <malloc+0x63c>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8e450513          	add	a0,a0,-1820 # 6680 <malloc+0x63c>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8ce50513          	add	a0,a0,-1842 # 6680 <malloc+0x63c>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	93258593          	add	a1,a1,-1742 # 66f8 <malloc+0x6b4>
  ...
  unlink("unlinkread");
     ...
     e32:	85250513          	add	a0,a0,-1966 # 6680 <malloc+0x63c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	84250513          	add	a0,a0,-1982 # 6690 <malloc+0x64c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	84e50513          	add	a0,a0,-1970 # 66b8 <malloc+0x674>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	85250513          	add	a0,a0,-1966 # 66d8 <malloc+0x694>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	85e50513          	add	a0,a0,-1954 # 6700 <malloc+0x6bc>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	86250513          	add	a0,a0,-1950 # 6720 <malloc+0x6dc>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	86650513          	add	a0,a0,-1946 # 6740 <malloc+0x6fc>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	77258593          	add	a1,a1,1906 # 66b0 <malloc+0x66c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	80a58593          	add	a1,a1,-2038 # 6768 <malloc+0x724>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7fa50513          	add	a0,a0,2042 # 6760 <malloc+0x71c>
  ...
  unlink("lf1");
     ...
     f7e:	7e650513          	add	a0,a0,2022 # 6760 <malloc+0x71c>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7d450513          	add	a0,a0,2004 # 6760 <malloc+0x71c>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7c650513          	add	a0,a0,1990 # 6768 <malloc+0x724>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	78e58593          	add	a1,a1,1934 # 6768 <malloc+0x724>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	77850513          	add	a0,a0,1912 # 6768 <malloc+0x724>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	76058593          	add	a1,a1,1888 # 6760 <malloc+0x71c>
    1008:	00005517          	auipc	a0,0x5
    100c:	76050513          	add	a0,a0,1888 # 6768 <malloc+0x724>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	74458593          	add	a1,a1,1860 # 6760 <malloc+0x71c>
    1024:	00006517          	auipc	a0,0x6
    1028:	84c50513          	add	a0,a0,-1972 # 6870 <malloc+0x82c>
    ...
    104a:	72a50513          	add	a0,a0,1834 # 6770 <malloc+0x72c>
    ...
    1066:	72650513          	add	a0,a0,1830 # 6788 <malloc+0x744>
    ...
    1082:	72250513          	add	a0,a0,1826 # 67a0 <malloc+0x75c>
    ...
    109e:	72650513          	add	a0,a0,1830 # 67c0 <malloc+0x77c>
    ...
    10ba:	73a50513          	add	a0,a0,1850 # 67f0 <malloc+0x7ac>
    ...
    10d6:	73650513          	add	a0,a0,1846 # 6808 <malloc+0x7c4>
    ...
    10f2:	73250513          	add	a0,a0,1842 # 6820 <malloc+0x7dc>
    ...
    110e:	73e50513          	add	a0,a0,1854 # 6848 <malloc+0x804>
    ...
    112a:	75250513          	add	a0,a0,1874 # 6878 <malloc+0x834>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	74098993          	add	s3,s3,1856 # 6898 <malloc+0x854>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	71450513          	add	a0,a0,1812 # 68a8 <malloc+0x864>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6cea0a13          	add	s4,s4,1742 # 68c8 <malloc+0x884>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	67c50513          	add	a0,a0,1660 # 68c8 <malloc+0x884>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	61450513          	add	a0,a0,1556 # 68d0 <malloc+0x88c>
    ...
    12e0:	61450513          	add	a0,a0,1556 # 68f0 <malloc+0x8ac>
    ...
    12fc:	61850513          	add	a0,a0,1560 # 6910 <malloc+0x8cc>
...
000000000000134a <badarg>:
{
    ...
    1368:	e2498993          	add	s3,s3,-476 # 6188 <malloc+0x144>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	77a78793          	add	a5,a5,1914 # 7b68 <malloc+0x1b24>
  ...
  if(pid == 0){
    ...
    144e:	16678793          	add	a5,a5,358 # 85b0 <malloc+0x256c>
    ...
    1472:	d1a50513          	add	a0,a0,-742 # 6188 <malloc+0x144>
    ...
    148a:	53250513          	add	a0,a0,1330 # 69b8 <malloc+0x974>
    ...
    14aa:	48a50513          	add	a0,a0,1162 # 6930 <malloc+0x8ec>
    ...
    14ca:	48a50513          	add	a0,a0,1162 # 6950 <malloc+0x90c>
    ...
    14ec:	48850513          	add	a0,a0,1160 # 6970 <malloc+0x92c>
    ...
    150c:	49050513          	add	a0,a0,1168 # 6998 <malloc+0x954>
    ...
    1526:	8f650513          	add	a0,a0,-1802 # 6e18 <malloc+0xdd4>
  ...
  if(st != 747){
    ...
    1570:	47450513          	add	a0,a0,1140 # 69e0 <malloc+0x99c>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	c4a50513          	add	a0,a0,-950 # 61e0 <malloc+0x19c>
  ...
  if(pid == 0){
    ...
    15cc:	c18a0a13          	add	s4,s4,-1000 # 61e0 <malloc+0x19c>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	470a8a93          	add	s5,s5,1136 # 6a40 <malloc+0x9fc>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	3c850513          	add	a0,a0,968 # 6a10 <malloc+0x9cc>
    ...
    1668:	3c450513          	add	a0,a0,964 # 6a28 <malloc+0x9e4>
    ...
    1686:	3ce50513          	add	a0,a0,974 # 6a50 <malloc+0xa0c>
    ...
    16ac:	b38a0a13          	add	s4,s4,-1224 # 61e0 <malloc+0x19c>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	3c0a8a93          	add	s5,s5,960 # 6a70 <malloc+0xa2c>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	ae650513          	add	a0,a0,-1306 # 61e0 <malloc+0x19c>
  ...
  exit(xstatus);
    ...
    171c:	31050513          	add	a0,a0,784 # 6a28 <malloc+0x9e4>
    ...
    173a:	34250513          	add	a0,a0,834 # 6a78 <malloc+0xa34>
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	a2c78793          	add	a5,a5,-1492 # 6188 <malloc+0x144>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	33078793          	add	a5,a5,816 # 6a98 <malloc+0xa54>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	32850513          	add	a0,a0,808 # 6aa0 <malloc+0xa5c>
  ...
  if(pid == 0) {
    ...
    17ac:	2f850513          	add	a0,a0,760 # 6aa0 <malloc+0xa5c>
    ...
    17c8:	2fc50513          	add	a0,a0,764 # 6ac0 <malloc+0xa7c>
    ...
    17e6:	22e50513          	add	a0,a0,558 # 6a10 <malloc+0x9cc>
    ...
    1802:	2aa50513          	add	a0,a0,682 # 6aa8 <malloc+0xa64>
    ...
    1820:	96c50513          	add	a0,a0,-1684 # 6188 <malloc+0x144>
  ...
  if(xstatus != 0)
    ...
    1854:	28050513          	add	a0,a0,640 # 6ad0 <malloc+0xa8c>
    ...
    1870:	27c50513          	add	a0,a0,636 # 6ae8 <malloc+0xaa4>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1884:	22050513          	add	a0,a0,544 # 6aa0 <malloc+0xa5c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	cae50513          	add	a0,a0,-850 # 6558 <malloc+0x514>
    ...
    18ca:	16250513          	add	a0,a0,354 # 6a28 <malloc+0x9e4>
  ...
  unlink("echo-ok");
    ...
    18e4:	1c050513          	add	a0,a0,448 # 6aa0 <malloc+0xa5c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	1f650513          	add	a0,a0,502 # 6b00 <malloc+0xabc>
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d6:	14650513          	add	a0,a0,326 # 6b18 <malloc+0xad4>
    ...
    1a18:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0d050513          	add	a0,a0,208 # 6b30 <malloc+0xaec>
    ...
    1a80:	0cc50513          	add	a0,a0,204 # 6b48 <malloc+0xb04>
    ...
    1ab2:	0b250513          	add	a0,a0,178 # 6b60 <malloc+0xb1c>
    ...
    1afe:	08650513          	add	a0,a0,134 # 6b80 <malloc+0xb3c>
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	ea450513          	add	a0,a0,-348 # 6a10 <malloc+0x9cc>
    ...
    1b8c:	01050513          	add	a0,a0,16 # 6b98 <malloc+0xb54>
    ...
    1ba8:	00c50513          	add	a0,a0,12 # 6bb0 <malloc+0xb6c>
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	df450513          	add	a0,a0,-524 # 6a10 <malloc+0x9cc>
    ...
    1c44:	dd050513          	add	a0,a0,-560 # 6a10 <malloc+0x9cc>
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	f1650513          	add	a0,a0,-234 # 6bd0 <malloc+0xb8c>
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	ece50513          	add	a0,a0,-306 # 6be0 <malloc+0xb9c>
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	0b850513          	add	a0,a0,184 # 6e18 <malloc+0xdd4>
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	01a50513          	add	a0,a0,26 # 6e18 <malloc+0xdd4>
    ...
    1e2e:	c7e50513          	add	a0,a0,-898 # 6aa8 <malloc+0xa64>
    ...
    1ea0:	d6450513          	add	a0,a0,-668 # 6c00 <malloc+0xbbc>
    ...
    1ed4:	d4850513          	add	a0,a0,-696 # 6c18 <malloc+0xbd4>
    ...
    1f36:	d0e50513          	add	a0,a0,-754 # 6c40 <malloc+0xbfc>
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	22250513          	add	a0,a0,546 # 61f8 <malloc+0x1b4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2016:	1e6b0b13          	add	s6,s6,486 # 61f8 <malloc+0x1b4>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c4ec0c13          	add	s8,s8,-946 # 6c68 <malloc+0xc24>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9ea50513          	add	a0,a0,-1558 # 6a10 <malloc+0x9cc>
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	bce50513          	add	a0,a0,-1074 # 6cb8 <malloc+0xc74>
    ...
    2112:	b6250513          	add	a0,a0,-1182 # 6c70 <malloc+0xc2c>
    ...
    212e:	b5e50513          	add	a0,a0,-1186 # 6c88 <malloc+0xc44>
    ...
    214a:	b5a50513          	add	a0,a0,-1190 # 6ca0 <malloc+0xc5c>
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	81450513          	add	a0,a0,-2028 # 6a10 <malloc+0x9cc>
    ...
    2222:	ac250513          	add	a0,a0,-1342 # 6ce0 <malloc+0xc9c>
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	77050513          	add	a0,a0,1904 # 6a10 <malloc+0x9cc>
    ...
    22d0:	a3450513          	add	a0,a0,-1484 # 6d00 <malloc+0xcbc>
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	a1c50513          	add	a0,a0,-1508 # 6d18 <malloc+0xcd4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	9ea50513          	add	a0,a0,-1558 # 6d18 <malloc+0xcd4>
  ...
  close(fd);
    ...
    2368:	9c470713          	add	a4,a4,-1596 # 6d28 <malloc+0xce4>
    ...
    23bc:	a5050513          	add	a0,a0,-1456 # 6e08 <malloc+0xdc4>
    ...
    23e0:	a4c50513          	add	a0,a0,-1460 # 6e28 <malloc+0xde4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	a0e50513          	add	a0,a0,-1522 # 6e48 <malloc+0xe04>
    ...
    245a:	5ba50513          	add	a0,a0,1466 # 6a10 <malloc+0x9cc>
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	54c50513          	add	a0,a0,1356 # 6a10 <malloc+0x9cc>
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	8d050513          	add	a0,a0,-1840 # 6e18 <malloc+0xdd4>
    ...
    2602:	87250513          	add	a0,a0,-1934 # 6e70 <malloc+0xe2c>
    ...
    2622:	c3a50513          	add	a0,a0,-966 # 6258 <malloc+0x214>
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	4b278793          	add	a5,a5,1202 # 7b68 <malloc+0x1b24>
  ...
  if(ret != -1){
    ...
    26fc:	79050513          	add	a0,a0,1936 # 6e88 <malloc+0xe44>
    ...
    271a:	21a50513          	add	a0,a0,538 # 6930 <malloc+0x8ec>
    ...
    2738:	21c50513          	add	a0,a0,540 # 6950 <malloc+0x90c>
    ...
    2758:	21c50513          	add	a0,a0,540 # 6970 <malloc+0x92c>
    ...
    2776:	22650513          	add	a0,a0,550 # 6998 <malloc+0x954>
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	70a50513          	add	a0,a0,1802 # 6ec8 <malloc+0xe84>
  ...
  if(n >= 0){
    ...
    27f2:	6fa50513          	add	a0,a0,1786 # 6ee8 <malloc+0xea4>
    ...
    2810:	68450513          	add	a0,a0,1668 # 6e90 <malloc+0xe4c>
    ...
    282c:	68050513          	add	a0,a0,1664 # 6ea8 <malloc+0xe64>
    ...
    2846:	68e50513          	add	a0,a0,1678 # 6ed0 <malloc+0xe8c>
  ...
  if(n >= 0){
    ...
    28a6:	67650513          	add	a0,a0,1654 # 6f18 <malloc+0xed4>
    ...
    28c0:	61450513          	add	a0,a0,1556 # 6ed0 <malloc+0xe8c>
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	5fe50513          	add	a0,a0,1534 # 6f40 <malloc+0xefc>
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	5ba50513          	add	a0,a0,1466 # 6f60 <malloc+0xf1c>
  ...
  if(c != a + 1){
    ...
    2a0e:	5b650513          	add	a0,a0,1462 # 6fc0 <malloc+0xf7c>
    ...
    2a30:	55450513          	add	a0,a0,1364 # 6f80 <malloc+0xf3c>
    ...
    2a4c:	55850513          	add	a0,a0,1368 # 6fa0 <malloc+0xf5c>
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	44e50513          	add	a0,a0,1102 # 6fe0 <malloc+0xf9c>
    ...
    2bb2:	47a50513          	add	a0,a0,1146 # 7028 <malloc+0xfe4>
    ...
    2bd2:	47a50513          	add	a0,a0,1146 # 7048 <malloc+0x1004>
    ...
    2bf2:	49a50513          	add	a0,a0,1178 # 7088 <malloc+0x1044>
    ...
    2c0e:	4ae50513          	add	a0,a0,1198 # 70b8 <malloc+0x1074>
    ...
    2c2e:	4c650513          	add	a0,a0,1222 # 70f0 <malloc+0x10ac>
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	4b450513          	add	a0,a0,1204 # 7118 <malloc+0x10d4>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	4a250513          	add	a0,a0,1186 # 7118 <malloc+0x10d4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	45650513          	add	a0,a0,1110 # 7120 <malloc+0x10dc>
    ...
    2cea:	45250513          	add	a0,a0,1106 # 7138 <malloc+0x10f4>
    ...
    2d06:	e1650513          	add	a0,a0,-490 # 6b18 <malloc+0xad4>
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	42450513          	add	a0,a0,1060 # 7150 <malloc+0x110c>
  ...
  close(fd);
    ...
    2d78:	cb450513          	add	a0,a0,-844 # 6a28 <malloc+0x9e4>
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	05650513          	add	a0,a0,86 # 6e18 <malloc+0xdd4>
  ...
  if(pid == 0){
    ...
    2e7c:	fa050513          	add	a0,a0,-96 # 6e18 <malloc+0xdd4>
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	e2c50513          	add	a0,a0,-468 # 6e18 <malloc+0xdd4>
    ...
    3044:	14850513          	add	a0,a0,328 # 6188 <malloc+0x144>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	1ac78793          	add	a5,a5,428 # 61f8 <malloc+0x1b4>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	2aa50513          	add	a0,a0,682 # 7328 <malloc+0x12e4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	0f050513          	add	a0,a0,240 # 7180 <malloc+0x113c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	13250513          	add	a0,a0,306 # 71d8 <malloc+0x1194>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	18c50513          	add	a0,a0,396 # 7250 <malloc+0x120c>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	1e050513          	add	a0,a0,480 # 72c0 <malloc+0x127c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	22650513          	add	a0,a0,550 # 7318 <malloc+0x12d4>
  ...
  unlink("12345678901234");
    ...
    3174:	fe850513          	add	a0,a0,-24 # 7158 <malloc+0x1114>
    ...
    3190:	01450513          	add	a0,a0,20 # 71a0 <malloc+0x115c>
    ...
    31ac:	06050513          	add	a0,a0,96 # 7208 <malloc+0x11c4>
    ...
    31c8:	0bc50513          	add	a0,a0,188 # 7280 <malloc+0x123c>
    ...
    31e4:	10050513          	add	a0,a0,256 # 72e0 <malloc+0x129c>
    ...
    3200:	13c50513          	add	a0,a0,316 # 7338 <malloc+0x12f4>
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	12850513          	add	a0,a0,296 # 7370 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	10e50513          	add	a0,a0,270 # 7380 <malloc+0x133c>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	06e50513          	add	a0,a0,110 # 7370 <malloc+0x132c>
  ...
  unlink("diskfulldir");
    ...
    331a:	05a50513          	add	a0,a0,90 # 7370 <malloc+0x132c>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	f5c50513          	add	a0,a0,-164 # 73a0 <malloc+0x135c>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	f6e50513          	add	a0,a0,-146 # 73d0 <malloc+0x138c>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	f5a50513          	add	a0,a0,-166 # 73d0 <malloc+0x138c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	f8650513          	add	a0,a0,-122 # 7410 <malloc+0x13cc>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	fa250513          	add	a0,a0,-94 # 7440 <malloc+0x13fc>
    ...
    34c2:	f1a50513          	add	a0,a0,-230 # 73d8 <malloc+0x1394>
    ...
    34de:	f1650513          	add	a0,a0,-234 # 73f0 <malloc+0x13ac>
    ...
    34fa:	f2a50513          	add	a0,a0,-214 # 7420 <malloc+0x13dc>
    ...
    3516:	f3650513          	add	a0,a0,-202 # 7448 <malloc+0x1404>
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	e8a50513          	add	a0,a0,-374 # 73d0 <malloc+0x138c>
    ...
    355e:	e7650513          	add	a0,a0,-394 # 73d0 <malloc+0x138c>
    ...
    3572:	ea250513          	add	a0,a0,-350 # 7410 <malloc+0x13cc>
    ...
    3592:	48250513          	add	a0,a0,1154 # 6a10 <malloc+0x9cc>
    ...
    35ae:	e2e50513          	add	a0,a0,-466 # 73d8 <malloc+0x1394>
    ...
    35ca:	e9a50513          	add	a0,a0,-358 # 7460 <malloc+0x141c>
    ...
    35e6:	e3e50513          	add	a0,a0,-450 # 7420 <malloc+0x13dc>
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	e5850513          	add	a0,a0,-424 # 7478 <malloc+0x1434>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	e4450513          	add	a0,a0,-444 # 7478 <malloc+0x1434>
  ...
  if(chdir("..") < 0){
    ...
    364c:	e5050513          	add	a0,a0,-432 # 7498 <malloc+0x1454>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	e1c50513          	add	a0,a0,-484 # 7478 <malloc+0x1434>
    ...
    3680:	d5c50513          	add	a0,a0,-676 # 73d8 <malloc+0x1394>
    ...
    369c:	de850513          	add	a0,a0,-536 # 7480 <malloc+0x143c>
    ...
    36b8:	dec50513          	add	a0,a0,-532 # 74a0 <malloc+0x145c>
    ...
    36d4:	de850513          	add	a0,a0,-536 # 74b8 <malloc+0x1474>
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	f0850513          	add	a0,a0,-248 # 7600 <malloc+0x15bc>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	dc850513          	add	a0,a0,-568 # 74d0 <malloc+0x148c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	dd050513          	add	a0,a0,-560 # 74f0 <malloc+0x14ac>
  ...
  write(fd, "ff", 2);
    ...
    373c:	ec858593          	add	a1,a1,-312 # 7600 <malloc+0x15bc>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	d7e50513          	add	a0,a0,-642 # 74d0 <malloc+0x148c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	de250513          	add	a0,a0,-542 # 7548 <malloc+0x1504>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	df250513          	add	a0,a0,-526 # 7570 <malloc+0x152c>
  ...
  write(fd, "FF", 2);
    ...
    379a:	e0a58593          	add	a1,a1,-502 # 75a0 <malloc+0x155c>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	df650513          	add	a0,a0,-522 # 75a8 <malloc+0x1564>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	dfe58593          	add	a1,a1,-514 # 75f8 <malloc+0x15b4>
    3802:	00004517          	auipc	a0,0x4
    3806:	d6e50513          	add	a0,a0,-658 # 7570 <malloc+0x152c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	d5a50513          	add	a0,a0,-678 # 7570 <malloc+0x152c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	d4450513          	add	a0,a0,-700 # 7570 <malloc+0x152c>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	c9050513          	add	a0,a0,-880 # 74d0 <malloc+0x148c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e3c50513          	add	a0,a0,-452 # 7690 <malloc+0x164c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	e5850513          	add	a0,a0,-424 # 76c0 <malloc+0x167c>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	e7450513          	add	a0,a0,-396 # 76f0 <malloc+0x16ac>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	d6650513          	add	a0,a0,-666 # 75f8 <malloc+0x15b4>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	ca450513          	add	a0,a0,-860 # 7570 <malloc+0x152c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	e9c50513          	add	a0,a0,-356 # 7780 <malloc+0x173c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	eb450513          	add	a0,a0,-332 # 77b0 <malloc+0x176c>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	bbc50513          	add	a0,a0,-1092 # 74d0 <malloc+0x148c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	ba650513          	add	a0,a0,-1114 # 74d0 <malloc+0x148c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	b9050513          	add	a0,a0,-1136 # 74d0 <malloc+0x148c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	eec58593          	add	a1,a1,-276 # 7840 <malloc+0x17fc>
    395c:	00004517          	auipc	a0,0x4
    3960:	e2450513          	add	a0,a0,-476 # 7780 <malloc+0x173c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	ed058593          	add	a1,a1,-304 # 7840 <malloc+0x17fc>
    3978:	00004517          	auipc	a0,0x4
    397c:	e3850513          	add	a0,a0,-456 # 77b0 <malloc+0x176c>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	c6c58593          	add	a1,a1,-916 # 75f8 <malloc+0x15b4>
    3994:	00004517          	auipc	a0,0x4
    3998:	b5c50513          	add	a0,a0,-1188 # 74f0 <malloc+0x14ac>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	dd850513          	add	a0,a0,-552 # 7780 <malloc+0x173c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	df450513          	add	a0,a0,-524 # 77b0 <malloc+0x176c>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	c2850513          	add	a0,a0,-984 # 75f8 <malloc+0x15b4>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	dcc50513          	add	a0,a0,-564 # 77b0 <malloc+0x176c>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	d8850513          	add	a0,a0,-632 # 7780 <malloc+0x173c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	ae450513          	add	a0,a0,-1308 # 74f0 <malloc+0x14ac>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	f7050513          	add	a0,a0,-144 # 7990 <malloc+0x194c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	bc450513          	add	a0,a0,-1084 # 75f8 <malloc+0x15b4>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	aa850513          	add	a0,a0,-1368 # 74f0 <malloc+0x14ac>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	a7450513          	add	a0,a0,-1420 # 74d0 <malloc+0x148c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	f9050513          	add	a0,a0,-112 # 7a00 <malloc+0x19bc>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	a4c50513          	add	a0,a0,-1460 # 74d0 <malloc+0x148c>
    ...
    3aaa:	a3250513          	add	a0,a0,-1486 # 74d8 <malloc+0x1494>
    ...
    3ac6:	a3650513          	add	a0,a0,-1482 # 74f8 <malloc+0x14b4>
    ...
    3ae2:	a3a50513          	add	a0,a0,-1478 # 7518 <malloc+0x14d4>
    ...
    3afe:	a5650513          	add	a0,a0,-1450 # 7550 <malloc+0x150c>
    ...
    3b1a:	a6a50513          	add	a0,a0,-1430 # 7580 <malloc+0x153c>
    ...
    3b36:	a8650513          	add	a0,a0,-1402 # 75b8 <malloc+0x1574>
    ...
    3b52:	a8a50513          	add	a0,a0,-1398 # 75d8 <malloc+0x1594>
    ...
    3b6e:	a9e50513          	add	a0,a0,-1378 # 7608 <malloc+0x15c4>
    ...
    3b8a:	aaa50513          	add	a0,a0,-1366 # 7630 <malloc+0x15ec>
    ...
    3ba6:	aae50513          	add	a0,a0,-1362 # 7650 <malloc+0x160c>
    ...
    3bc2:	aba50513          	add	a0,a0,-1350 # 7678 <malloc+0x1634>
    ...
    3bde:	ac650513          	add	a0,a0,-1338 # 76a0 <malloc+0x165c>
    ...
    3bfa:	ada50513          	add	a0,a0,-1318 # 76d0 <malloc+0x168c>
    ...
    3c16:	ae650513          	add	a0,a0,-1306 # 76f8 <malloc+0x16b4>
    ...
    3c32:	ae250513          	add	a0,a0,-1310 # 7710 <malloc+0x16cc>
    ...
    3c4e:	ae650513          	add	a0,a0,-1306 # 7730 <malloc+0x16ec>
    ...
    3c6a:	aea50513          	add	a0,a0,-1302 # 7750 <malloc+0x170c>
    ...
    3c86:	b0e50513          	add	a0,a0,-1266 # 7790 <malloc+0x174c>
    ...
    3ca2:	b2250513          	add	a0,a0,-1246 # 77c0 <malloc+0x177c>
    ...
    3cbe:	b2650513          	add	a0,a0,-1242 # 77e0 <malloc+0x179c>
    ...
    3cda:	b2a50513          	add	a0,a0,-1238 # 7800 <malloc+0x17bc>
    ...
    3cf6:	b2e50513          	add	a0,a0,-1234 # 7820 <malloc+0x17dc>
    ...
    3d12:	b4250513          	add	a0,a0,-1214 # 7850 <malloc+0x180c>
    ...
    3d2e:	b4e50513          	add	a0,a0,-1202 # 7878 <malloc+0x1834>
    ...
    3d4a:	b5a50513          	add	a0,a0,-1190 # 78a0 <malloc+0x185c>
    ...
    3d66:	b6650513          	add	a0,a0,-1178 # 78c8 <malloc+0x1884>
    ...
    3d82:	b6a50513          	add	a0,a0,-1174 # 78e8 <malloc+0x18a4>
    ...
    3d9e:	b6e50513          	add	a0,a0,-1170 # 7908 <malloc+0x18c4>
    ...
    3dba:	b7a50513          	add	a0,a0,-1158 # 7930 <malloc+0x18ec>
    ...
    3dd6:	b7e50513          	add	a0,a0,-1154 # 7950 <malloc+0x190c>
    ...
    3df2:	b8250513          	add	a0,a0,-1150 # 7970 <malloc+0x192c>
    ...
    3e0e:	b8e50513          	add	a0,a0,-1138 # 7998 <malloc+0x1954>
    ...
    3e2a:	80a50513          	add	a0,a0,-2038 # 7630 <malloc+0x15ec>
    ...
    3e46:	b7650513          	add	a0,a0,-1162 # 79b8 <malloc+0x1974>
    ...
    3e62:	b7a50513          	add	a0,a0,-1158 # 79d8 <malloc+0x1994>
    ...
    3e7e:	b8e50513          	add	a0,a0,-1138 # 7a08 <malloc+0x19c4>
    ...
    3e9a:	b9250513          	add	a0,a0,-1134 # 7a28 <malloc+0x19e4>
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	b8450513          	add	a0,a0,-1148 # 7a40 <malloc+0x19fc>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	b7250513          	add	a0,a0,-1166 # 7a40 <malloc+0x19fc>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	99050513          	add	a0,a0,-1648 # 6870 <malloc+0x82c>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	5a650513          	add	a0,a0,1446 # 7498 <malloc+0x1454>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	53c50513          	add	a0,a0,1340 # 7440 <malloc+0x13fc>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	b9250513          	add	a0,a0,-1134 # 7aa8 <malloc+0x1a64>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	ba850513          	add	a0,a0,-1112 # 7ad0 <malloc+0x1a8c>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	b0650513          	add	a0,a0,-1274 # 7a40 <malloc+0x19fc>
    ...
    3f5c:	af050513          	add	a0,a0,-1296 # 7a48 <malloc+0x1a04>
    ...
    3f78:	aec50513          	add	a0,a0,-1300 # 7a60 <malloc+0x1a1c>
    ...
    3f94:	ae850513          	add	a0,a0,-1304 # 7a78 <malloc+0x1a34>
    ...
    3fb0:	ae450513          	add	a0,a0,-1308 # 7a90 <malloc+0x1a4c>
    ...
    3fcc:	48050513          	add	a0,a0,1152 # 7448 <malloc+0x1404>
    ...
    3fe8:	acc50513          	add	a0,a0,-1332 # 7ab0 <malloc+0x1a6c>
    ...
    4004:	ad850513          	add	a0,a0,-1320 # 7ad8 <malloc+0x1a94>
    ...
    4020:	adc50513          	add	a0,a0,-1316 # 7af8 <malloc+0x1ab4>
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	ad050513          	add	a0,a0,-1328 # 7b18 <malloc+0x1ad4>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	ab450513          	add	a0,a0,-1356 # 7b18 <malloc+0x1ad4>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	ae850513          	add	a0,a0,-1304 # 7b60 <malloc+0x1b1c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	ad050513          	add	a0,a0,-1328 # 7b60 <malloc+0x1b1c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	abc50513          	add	a0,a0,-1348 # 7b60 <malloc+0x1b1c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	aa850513          	add	a0,a0,-1368 # 7b60 <malloc+0x1b1c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	a9458593          	add	a1,a1,-1388 # 7b60 <malloc+0x1b1c>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	28c50513          	add	a0,a0,652 # 6360 <malloc+0x31c>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a3050513          	add	a0,a0,-1488 # 7b18 <malloc+0x1ad4>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	77250513          	add	a0,a0,1906 # 6870 <malloc+0x82c>
  ...
  fd = open(".", 0);
    ...
    4118:	75c50513          	add	a0,a0,1884 # 6870 <malloc+0x82c>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	0d058593          	add	a1,a1,208 # 61f8 <malloc+0x1b4>
  ...
  close(fd);
    ...
    4158:	9cc50513          	add	a0,a0,-1588 # 7b20 <malloc+0x1adc>
    ...
    4174:	9d050513          	add	a0,a0,-1584 # 7b40 <malloc+0x1afc>
    ...
    4190:	9e450513          	add	a0,a0,-1564 # 7b70 <malloc+0x1b2c>
    ...
    41ac:	9c850513          	add	a0,a0,-1592 # 7b70 <malloc+0x1b2c>
    ...
    41c8:	9d450513          	add	a0,a0,-1580 # 7b98 <malloc+0x1b54>
    ...
    41e4:	9e050513          	add	a0,a0,-1568 # 7bc0 <malloc+0x1b7c>
    ...
    4200:	9ec50513          	add	a0,a0,-1556 # 7be8 <malloc+0x1ba4>
    ...
    421c:	9f850513          	add	a0,a0,-1544 # 7c10 <malloc+0x1bcc>
    ...
    4238:	9fc50513          	add	a0,a0,-1540 # 7c30 <malloc+0x1bec>
    ...
    4254:	a0850513          	add	a0,a0,-1528 # 7c58 <malloc+0x1c14>
...
000000000000426a <iref>:
{
    ...
    4288:	9eca0a13          	add	s4,s4,-1556 # 7c70 <malloc+0x1c2c>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4ec48493          	add	s1,s1,1260 # 7778 <malloc+0x1734>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	0cca8a93          	add	s5,s5,204 # 6360 <malloc+0x31c>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	8cc98993          	add	s3,s3,-1844 # 7b68 <malloc+0x1b24>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9d050513          	add	a0,a0,-1584 # 7c78 <malloc+0x1c34>
    ...
    42c8:	9cc50513          	add	a0,a0,-1588 # 7c90 <malloc+0x1c4c>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	14098993          	add	s3,s3,320 # 7498 <malloc+0x1454>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	91090913          	add	s2,s2,-1776 # 7c70 <malloc+0x1c2c>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	0c050513          	add	a0,a0,192 # 7440 <malloc+0x13fc>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	8f850513          	add	a0,a0,-1800 # 7ca8 <malloc+0x1c64>
  ...
  if(pid == 0){
    ...
    43d8:	8d450513          	add	a0,a0,-1836 # 7ca8 <malloc+0x1c64>
    ...
    43ee:	8de50513          	add	a0,a0,-1826 # 7cc8 <malloc+0x1c84>
    ...
    440a:	8aa50513          	add	a0,a0,-1878 # 7cb0 <malloc+0x1c6c>
    ...
    4426:	5ee50513          	add	a0,a0,1518 # 6a10 <malloc+0x9cc>
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	85850513          	add	a0,a0,-1960 # 7ca8 <malloc+0x1c64>
    ...
    4468:	79c50513          	add	a0,a0,1948 # 6c00 <malloc+0xbbc>
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	84e50513          	add	a0,a0,-1970 # 7cf0 <malloc+0x1cac>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	82250513          	add	a0,a0,-2014 # 7cf0 <malloc+0x1cac>
  ...
  sleep(10); // one second
    ...
    450a:	6ca50513          	add	a0,a0,1738 # 6bd0 <malloc+0xb8c>
    ...
    4524:	7d048493          	add	s1,s1,2000 # 7cf0 <malloc+0x1cac>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	7a850513          	add	a0,a0,1960 # 7cf0 <malloc+0x1cac>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	44250513          	add	a0,a0,1090 # 6a10 <malloc+0x9cc>
    ...
    45f8:	70c50513          	add	a0,a0,1804 # 7d00 <malloc+0x1cbc>
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	59c50513          	add	a0,a0,1436 # 6bd0 <malloc+0xb8c>
  ...
  if(pid2 == 0)
    ...
    4666:	3ae50513          	add	a0,a0,942 # 6a10 <malloc+0x9cc>
  ...
  if(pid3 == 0){
    ...
    46aa:	b5258593          	add	a1,a1,-1198 # 61f8 <malloc+0x1b4>
    ...
    46d4:	34050513          	add	a0,a0,832 # 6a10 <malloc+0x9cc>
    ...
    46f0:	63450513          	add	a0,a0,1588 # 7d20 <malloc+0x1cdc>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    472c:	61050513          	add	a0,a0,1552 # 7d38 <malloc+0x1cf4>
  ...
  printf("kill... ");
    ...
    4758:	5fc50513          	add	a0,a0,1532 # 7d50 <malloc+0x1d0c>
  ...
  printf("wait... ");
    ...
    4786:	5de50513          	add	a0,a0,1502 # 7d60 <malloc+0x1d1c>
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	20e50513          	add	a0,a0,526 # 6a10 <malloc+0x9cc>
    ...
    4822:	37a50513          	add	a0,a0,890 # 6b98 <malloc+0xb54>
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	28450513          	add	a0,a0,644 # 6b18 <malloc+0xad4>
    ...
    48cc:	93058593          	add	a1,a1,-1744 # 61f8 <malloc+0x1b4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	3e450513          	add	a0,a0,996 # 7d70 <malloc+0x1d2c>
    ...
    49ac:	06850513          	add	a0,a0,104 # 6a10 <malloc+0x9cc>
    ...
    49f8:	39c50513          	add	a0,a0,924 # 7d90 <malloc+0x1d4c>
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a9c:	32850513          	add	a0,a0,808 # 7dc0 <malloc+0x1d7c>
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	29650513          	add	a0,a0,662 # 7df0 <malloc+0x1dac>
    ...
    4b7a:	2a250513          	add	a0,a0,674 # 7e18 <malloc+0x1dd4>
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	22650513          	add	a0,a0,550 # 7de0 <malloc+0x1d9c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	23e50513          	add	a0,a0,574 # 7e38 <malloc+0x1df4>
  ...
  unlink("sharedfd");
    ...
    4c3a:	1aa50513          	add	a0,a0,426 # 7de0 <malloc+0x1d9c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	20450513          	add	a0,a0,516 # 7e60 <malloc+0x1e1c>
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	1d878793          	add	a5,a5,472 # 7e78 <malloc+0x1e34>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1d478793          	add	a5,a5,468 # 7e80 <malloc+0x1e3c>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1d078793          	add	a5,a5,464 # 7e88 <malloc+0x1e44>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	1cc78793          	add	a5,a5,460 # 7e90 <malloc+0x1e4c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	0e650513          	add	a0,a0,230 # 6e18 <malloc+0xdd4>
    ...
    4db0:	0ec50513          	add	a0,a0,236 # 7e98 <malloc+0x1e54>
    ...
    4dca:	0e250513          	add	a0,a0,226 # 7ea8 <malloc+0x1e64>
    ...
    4df0:	0d450513          	add	a0,a0,212 # 7ec0 <malloc+0x1e7c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	05c50513          	add	a0,a0,92 # 7ed0 <malloc+0x1e8c>
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	012b8b93          	add	s7,s7,18 # 7ee8 <malloc+0x1ea4>
  for(i = 0; i < N; i++){
    ...
    4f1c:	fd850513          	add	a0,a0,-40 # 7ef0 <malloc+0x1eac>
    ...
    4f3a:	fb250513          	add	a0,a0,-78 # 7ee8 <malloc+0x1ea4>
  ...
  fd = open(".", 0);
    ...
    4f72:	90250513          	add	a0,a0,-1790 # 6870 <malloc+0x82c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	f2a50513          	add	a0,a0,-214 # 7f10 <malloc+0x1ecc>
    ...
    500a:	f2a50513          	add	a0,a0,-214 # 7f30 <malloc+0x1eec>
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	f1a50513          	add	a0,a0,-230 # 7f58 <malloc+0x1f14>
    ...
    505e:	9b650513          	add	a0,a0,-1610 # 6a10 <malloc+0x9cc>
...
0000000000005208 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	d0450513          	add	a0,a0,-764 # 7f90 <malloc+0x1f4c>
  ...
  for(i = 0; ; i++){
    ...
    52f4:	cb050513          	add	a0,a0,-848 # 7fa0 <malloc+0x1f5c>
    ...
    5310:	cb450513          	add	a0,a0,-844 # 7fc0 <malloc+0x1f7c>
    ...
    532c:	cb850513          	add	a0,a0,-840 # 7fe0 <malloc+0x1f9c>
    ...
    5348:	cbc50513          	add	a0,a0,-836 # 8000 <malloc+0x1fbc>
    ...
    5364:	cc050513          	add	a0,a0,-832 # 8020 <malloc+0x1fdc>
    ...
    5380:	cbc50513          	add	a0,a0,-836 # 8038 <malloc+0x1ff4>
  ...
  unlink("bigfile.dat");
    ...
    53ae:	be650513          	add	a0,a0,-1050 # 7f90 <malloc+0x1f4c>
    ...
    53d2:	c8a50513          	add	a0,a0,-886 # 8058 <malloc+0x2014>
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	c7450513          	add	a0,a0,-908 # 8078 <malloc+0x2034>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5428:	c64c8c93          	add	s9,s9,-924 # 8088 <malloc+0x2044>
    name[0] = 'f';
    ...
    5498:	c0450513          	add	a0,a0,-1020 # 8098 <malloc+0x2054>
  ...
  printf("fsfull test finished\n");
    ...
    550e:	bae50513          	add	a0,a0,-1106 # 80b8 <malloc+0x2074>
    ...
    5564:	b4850513          	add	a0,a0,-1208 # 80a8 <malloc+0x2064>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b3e50513          	add	a0,a0,-1218 # 80d0 <malloc+0x208c>
  ...
  if(pid == 0) {
    ...
    55c6:	b3650513          	add	a0,a0,-1226 # 80f8 <malloc+0x20b4>
    ...
    55ea:	afa50513          	add	a0,a0,-1286 # 80e0 <malloc+0x209c>
    ...
    5612:	af250513          	add	a0,a0,-1294 # 8100 <malloc+0x20bc>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	aaa50513          	add	a0,a0,-1366 # 8108 <malloc+0x20c4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	b4098993          	add	s3,s3,-1216 # 61f8 <malloc+0x1b4>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	a7650513          	add	a0,a0,-1418 # 8160 <malloc+0x211c>
    ...
    570e:	a1650513          	add	a0,a0,-1514 # 8120 <malloc+0x20dc>
    ...
    572e:	a1650513          	add	a0,a0,-1514 # 8140 <malloc+0x20fc>
  ...
  while(1){
    ...
    5782:	a0250513          	add	a0,a0,-1534 # 8180 <malloc+0x213c>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	9c4b8b93          	add	s7,s7,-1596 # 81a0 <malloc+0x215c>
    int free0 = countfree();
    int free1 = 0;
    ...
    57fa:	9c2d0d13          	add	s10,s10,-1598 # 81b8 <malloc+0x2174>
          return 1;
        }
      }
    }
    ...
    5802:	9dac8c93          	add	s9,s9,-1574 # 81d8 <malloc+0x2194>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	93258593          	add	a1,a1,-1742 # 8208 <malloc+0x21c4>
  ...
  char *justone = 0;
    ...
    58f8:	91c58593          	add	a1,a1,-1764 # 8210 <malloc+0x21cc>
    ...
    590e:	95658593          	add	a1,a1,-1706 # 8260 <malloc+0x221c>
  ...
  int continuous = 0;
    ...
    593a:	8e250513          	add	a0,a0,-1822 # 8218 <malloc+0x21d4>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	8ec50513          	add	a0,a0,-1812 # 8248 <malloc+0x2204>
...
{
    5b4a:	1141                	add	sp,sp,-16
    5b4c:	e422                	sd	s0,8(sp)
    5b4e:	0800                	add	s0,sp,16
  char *dst;
  const char *src;
  ...
  if (src > dst) {
    ...
    5b58:	1602                	sll	a2,a2,0x20
    5b5a:	9201                	srl	a2,a2,0x20
    5b5c:	00c507b3          	add	a5,a0,a2
  dst = vdst;
    5b60:	872a                	mv	a4,a0
      *dst++ = *src++;
    5b62:	0585                	add	a1,a1,1
    5b64:	0705                	add	a4,a4,1
  ...
  return vdst;
    ...
    5b82:	fff6079b          	addw	a5,a2,-1
    5b86:	1782                	sll	a5,a5,0x20
    5b88:	9381                	srl	a5,a5,0x20
    5b8a:	fff7c793          	not	a5,a5
    5b8e:	97ba                	add	a5,a5,a4
      *--dst = *--src;
    5b90:	15fd                	add	a1,a1,-1
    5b92:	177d                	add	a4,a4,-1
...
{
    5ba2:	1141                	add	sp,sp,-16
    5ba4:	e422                	sd	s0,8(sp)
    5ba6:	0800                	add	s0,sp,16
  const char *p1 = s1, *p2 = s2;
  while (n-- > 0) {
    5ba8:	ca05                	beqz	a2,5bd8 <memcmp+0x36>
    5baa:	fff6069b          	addw	a3,a2,-1
    5bae:	1682                	sll	a3,a3,0x20
    5bb0:	9281                	srl	a3,a3,0x20
    5bb2:	0685                	add	a3,a3,1
    ...
    p1++;
    5bc2:	0505                	add	a0,a0,1
    p2++;
    5bc4:	0585                	add	a1,a1,1
  while (n-- > 0) {
...
{
    5bdc:	1141                	add	sp,sp,-16
    5bde:	e406                	sd	ra,8(sp)
    5be0:	e022                	sd	s0,0(sp)
    5be2:	0800                	add	s0,sp,16
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5d08:	92450513          	add	a0,a0,-1756 # 8628 <digits>
    5d0c:	883a                	mv	a6,a4
    5d0e:	2705                	addw	a4,a4,1
    5d10:	02c5f7bb          	remuw	a5,a1,a2
    5d14:	1782                	sll	a5,a5,0x20
    5d16:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5e9a:	792b8b93          	add	s7,s7,1938 # 8628 <digits>
    5e9e:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5eb2:	0992                	sll	s3,s3,0x4
    5eb4:	397d                	addw	s2,s2,-1
    ...
    5ef0:	6bc90913          	add	s2,s2,1724 # 85a8 <malloc+0x2564>
        while(*s != 0){
    5ef4:	02800593          	li	a1,40
    5ef8:	bff1                	j	5ed4 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5efa:	008b8913          	add	s2,s7,8
...
{
    5f5e:	715d                	add	sp,sp,-80
    5f60:	ec06                	sd	ra,24(sp)
    5f62:	e822                	sd	s0,16(sp)
    5f64:	1000                	add	s0,sp,32
...
{
    5f8c:	711d                	add	sp,sp,-96
    5f8e:	ec06                	sd	ra,24(sp)
    5f90:	e822                	sd	s0,16(sp)
    5f92:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5fc2:	1141                	add	sp,sp,-16
    5fc4:	e422                	sd	s0,8(sp)
    5fc6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fc8:	ff050693          	add	a3,a0,-16
    ...
    5ff8:	00e6ea63          	bltu	a3,a4,600c <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    6012:	02059813          	sll	a6,a1,0x20
    6016:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    6026:	02061593          	sll	a1,a2,0x20
    602a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    6044:	7139                	add	sp,sp,-64
    6046:	fc06                	sd	ra,56(sp)
    6048:	f822                	sd	s0,48(sp)
    604a:	f426                	sd	s1,40(sp)
    604c:	ec4e                	sd	s3,24(sp)
    604e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6050:	02051493          	sll	s1,a0,0x20
    6054:	9081                	srl	s1,s1,0x20
    6056:	04bd                	add	s1,s1,15
    6058:	8091                	srl	s1,s1,0x4
    605a:	0014899b          	addw	s3,s1,1
    605e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    6094:	3c090913          	add	s2,s2,960 # 9450 <freep>
  if(p == (char*)-1)
    6098:	5afd                	li	s5,-1
    ...
    60a8:	bd478793          	add	a5,a5,-1068 # fc78 <base>
  ...
  if(p == (char*)-1)
    ...
    6112:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6114:	02071693          	sll	a3,a4,0x20
    6118:	01c6d713          	srl	a4,a3,0x1c
