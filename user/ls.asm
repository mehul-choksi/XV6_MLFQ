...
ls(char *path)
{
 ...
 11c:	9c850513          	add	a0,a0,-1592 # ae0 <malloc+0x136>
 ...
 14e:	96658593          	add	a1,a1,-1690 # ab0 <malloc+0x106>
 152:	4509                	li	a0,2
 ...
 164:	96858593          	add	a1,a1,-1688 # ac8 <malloc+0x11e>
 168:	4509                	li	a0,2
 ...
 19a:	95a50513          	add	a0,a0,-1702 # af0 <malloc+0x146>
 ...
 1ea:	922a0a13          	add	s4,s4,-1758 # b08 <malloc+0x15e>
        printf("ls: cannot stat %s\n", buf);
 1ee:	00001a97          	auipc	s5,0x1
 1f2:	8daa8a93          	add	s5,s5,-1830 # ac8 <malloc+0x11e>
...
main(int argc, char *argv[])
{
 ...
 2c6:	85650513          	add	a0,a0,-1962 # b18 <malloc+0x16e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66e:	51650513          	add	a0,a0,1302 # b80 <digits>
 672:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 800:	384b8b93          	add	s7,s7,900 # b80 <digits>
 804:	03c9d793          	srl	a5,s3,0x3c
 ...
 818:	0992                	sll	s3,s3,0x4
 81a:	397d                	addw	s2,s2,-1
 ...
 856:	2ce90913          	add	s2,s2,718 # b20 <malloc+0x176>
        while(*s != 0){
...
{
 8f2:	711d                	add	sp,sp,-96
 8f4:	ec06                	sd	ra,24(sp)
 8f6:	e822                	sd	s0,16(sp)
 8f8:	1000                	add	s0,sp,32
 8fa:	e40c                	sd	a1,8(s0)
...
free(void *ap)
{
 928:	1141                	add	sp,sp,-16
 92a:	e422                	sd	s0,8(sp)
 92c:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 92e:	ff050693          	add	a3,a0,-16
 ...
 95e:	00e6ea63          	bltu	a3,a4,972 <free+0x4a>
{
 ...
 976:	6390                	ld	a2,0(a5)
 978:	02059813          	sll	a6,a1,0x20
 97c:	01c85713          	srl	a4,a6,0x1c
 ...
 986:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 98a:	4790                	lw	a2,8(a5)
 98c:	02061593          	sll	a1,a2,0x20
 990:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 9aa:	7139                	add	sp,sp,-64
 9ac:	fc06                	sd	ra,56(sp)
 9ae:	f822                	sd	s0,48(sp)
 9b0:	f426                	sd	s1,40(sp)
 9b2:	ec4e                	sd	s3,24(sp)
 9b4:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 9b6:	02051493          	sll	s1,a0,0x20
 9ba:	9081                	srl	s1,s1,0x20
 9bc:	04bd                	add	s1,s1,15
 9be:	8091                	srl	s1,s1,0x4
 9c0:	0014899b          	addw	s3,s1,1
 9c4:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9fa:	60a90913          	add	s2,s2,1546 # 1000 <freep>
  if(p == (char*)-1)
 9fe:	5afd                	li	s5,-1
 ...
 a0e:	61678793          	add	a5,a5,1558 # 1020 <base>
 ...
 a78:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a7a:	02071693          	sll	a3,a4,0x20
 a7e:	01c6d713          	srl	a4,a3,0x1c
