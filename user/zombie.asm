...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	4a850513          	add	a0,a0,1192 # 860 <digits>
 3c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c2:	34a70713          	add	a4,a4,842 # 808 <malloc+0x110>
 ...
 54e:	316b8b93          	add	s7,s7,790 # 860 <digits>
 ...
 5a4:	26090913          	add	s2,s2,608 # 800 <malloc+0x108>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 75c:	8b878793          	add	a5,a5,-1864 # 1010 <base>
 ...
 7c6:	c798                	sw	a4,8(a5)
        p += p->s.size;
 7c8:	02071693          	sll	a3,a4,0x20
 7cc:	01c6d713          	srl	a4,a3,0x1c
