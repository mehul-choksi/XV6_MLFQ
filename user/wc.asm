...
wc(int fd, char *name)
{
  ...
  3c:	928a0a13          	add	s4,s4,-1752 # 960 <malloc+0x102>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8da50513          	add	a0,a0,-1830 # 980 <malloc+0x122>
  ...
  d8:	89c50513          	add	a0,a0,-1892 # 970 <malloc+0x112>
...
main(int argc, char *argv[])
{
 ...
 15a:	81258593          	add	a1,a1,-2030 # 968 <malloc+0x10a>
 15e:	4501                	li	a0,0
 ...
 17a:	81a50513          	add	a0,a0,-2022 # 990 <malloc+0x132>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 522:	4ea50513          	add	a0,a0,1258 # a08 <digits>
 526:	883a                	mv	a6,a4
 528:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6b4:	358b8b93          	add	s7,s7,856 # a08 <digits>
 ...
 6cc:	0992                	sll	s3,s3,0x4
 6ce:	397d                	addw	s2,s2,-1
 ...
 70a:	2a290913          	add	s2,s2,674 # 9a8 <malloc+0x14a>
        while(*s != 0){
...
{
 7a6:	711d                	add	sp,sp,-96
 7a8:	ec06                	sd	ra,24(sp)
 7aa:	e822                	sd	s0,16(sp)
 7ac:	1000                	add	s0,sp,32
 7ae:	e40c                	sd	a1,8(s0)
...
free(void *ap)
{
 ...
 7de:	e422                	sd	s0,8(sp)
 7e0:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
 7e2:	ff050693          	add	a3,a0,-16
 ...
 812:	00e6ea63          	bltu	a3,a4,826 <free+0x4a>
{
 ...
 82a:	6390                	ld	a2,0(a5)
 82c:	02059813          	sll	a6,a1,0x20
 830:	01c85713          	srl	a4,a6,0x1c
 ...
 83a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 83e:	4790                	lw	a2,8(a5)
 840:	02061593          	sll	a1,a2,0x20
 844:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
 85e:	7139                	add	sp,sp,-64
 860:	fc06                	sd	ra,56(sp)
 862:	f822                	sd	s0,48(sp)
 864:	f426                	sd	s1,40(sp)
 866:	ec4e                	sd	s3,24(sp)
 868:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 86a:	02051493          	sll	s1,a0,0x20
 86e:	9081                	srl	s1,s1,0x20
 870:	04bd                	add	s1,s1,15
 872:	8091                	srl	s1,s1,0x4
 874:	0014899b          	addw	s3,s1,1
 878:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 8ae:	75690913          	add	s2,s2,1878 # 1000 <freep>
  if(p == (char*)-1)
 8b2:	5afd                	li	s5,-1
 ...
 8c2:	95278793          	add	a5,a5,-1710 # 1210 <base>
