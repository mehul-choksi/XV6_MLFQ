...
main(int argc, char *argv[])
{
  ...
  1a:	8fa78793          	add	a5,a5,-1798 # 910 <malloc+0x136>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8b450513          	add	a0,a0,-1868 # 8e0 <malloc+0x106>
  ...
  6c:	89050513          	add	a0,a0,-1904 # 8f8 <malloc+0x11e>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	85250513          	add	a0,a0,-1966 # 908 <malloc+0x12e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49e:	4e650513          	add	a0,a0,1254 # 980 <digits>
 4a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a4:	38870713          	add	a4,a4,904 # 928 <malloc+0x14e>
 ...
 630:	354b8b93          	add	s7,s7,852 # 980 <digits>
 ...
 686:	29e90913          	add	s2,s2,670 # 920 <malloc+0x146>
        while(*s != 0){
