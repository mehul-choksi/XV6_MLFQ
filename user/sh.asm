...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	32e58593          	add	a1,a1,814 # 1340 <malloc+0x108>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2f058593          	add	a1,a1,752 # 1350 <malloc+0x118>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	2be50513          	add	a0,a0,702 # 1358 <malloc+0x120>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	39270713          	add	a4,a4,914 # 1458 <malloc+0x220>
    ...
    panic("runcmd");
      ...
      e6:	27e50513          	add	a0,a0,638 # 1360 <malloc+0x128>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     108:	26458593          	add	a1,a1,612 # 1368 <malloc+0x130>
     10c:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     154:	22858593          	add	a1,a1,552 # 1378 <malloc+0x140>
     158:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1ea:	1a250513          	add	a0,a0,418 # 1388 <malloc+0x150>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	dfca8a93          	add	s5,s5,-516 # 13b0 <malloc+0x178>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ca:	dca50513          	add	a0,a0,-566 # 1390 <malloc+0x158>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	d1a60613          	add	a2,a2,-742 # 13b8 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6de:	cfeb0b13          	add	s6,s6,-770 # 13d8 <malloc+0x1a0>
  ...
  return ret;
     ...
     70c:	cb850513          	add	a0,a0,-840 # 13c0 <malloc+0x188>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c5e50513          	add	a0,a0,-930 # 13c8 <malloc+0x190>
...
0000000000000794 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b4:	c3060613          	add	a2,a2,-976 # 13e0 <malloc+0x1a8>
     7b8:	85ce                	mv	a1,s3
     7ba:	854a                	mv	a0,s2
...
0000000000000802 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     824:	bc8a0a13          	add	s4,s4,-1080 # 13e8 <malloc+0x1b0>
  ...
  if(peek(ps, es, ";")){
     ...
     85a:	b9a60613          	add	a2,a2,-1126 # 13f0 <malloc+0x1b8>
     85e:	85ce                	mv	a1,s3
     860:	854a                	mv	a0,s2
...
00000000000008aa <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c0:	afc60613          	add	a2,a2,-1284 # 13b8 <malloc+0x180>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f0:	b1c60613          	add	a2,a2,-1252 # 1408 <malloc+0x1d0>
     8f4:	85ca                	mv	a1,s2
     8f6:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96e:	b0670713          	add	a4,a4,-1274 # 1470 <malloc+0x238>
...
00000000000009e6 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a1a:	93260613          	add	a2,a2,-1742 # 1348 <malloc+0x110>
     a1e:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a50:	9dc58593          	add	a1,a1,-1572 # 1428 <malloc+0x1f0>
     a54:	4509                	li	a0,2
     a56:	00000097          	auipc	ra,0x0
     a5a:	6fc080e7          	jalr	1788(ra) # 1152 <fprintf>
    panic("syntax");
     a5e:	00001517          	auipc	a0,0x1
     a62:	96250513          	add	a0,a0,-1694 # 13c0 <malloc+0x188>
...
0000000000000a6e <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a82:	9ba48493          	add	s1,s1,-1606 # 1438 <malloc+0x200>
     a86:	4589                	li	a1,2
     a88:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	90c58593          	add	a1,a1,-1780 # 1440 <malloc+0x208>
     b3c:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efc:	5e850513          	add	a0,a0,1512 # 14e0 <digits>
     f00:	883a                	mv	a6,a4
     f02:	2705                	addw	a4,a4,1
     f04:	02c5f7bb          	remuw	a5,a1,a2
     f08:	1782                	sll	a5,a5,0x20
     f0a:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    108e:	456b8b93          	add	s7,s7,1110 # 14e0 <digits>
    1092:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10a6:	0992                	sll	s3,s3,0x4
    10a8:	397d                	addw	s2,s2,-1
    ...
    10e4:	37090913          	add	s2,s2,880 # 1450 <malloc+0x218>
        while(*s != 0){
    10e8:	02800593          	li	a1,40
    10ec:	bff1                	j	10c8 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10ee:	008b8913          	add	s2,s7,8
...
free(void *ap)
{
    11b6:	1141                	add	sp,sp,-16
    11b8:	e422                	sd	s0,8(sp)
    11ba:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11bc:	ff050693          	add	a3,a0,-16
    ...
    11ec:	00e6ea63          	bltu	a3,a4,1200 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1206:	02059813          	sll	a6,a1,0x20
    120a:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    121a:	02061593          	sll	a1,a2,0x20
    121e:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    1238:	7139                	add	sp,sp,-64
    123a:	fc06                	sd	ra,56(sp)
    123c:	f822                	sd	s0,48(sp)
    123e:	f426                	sd	s1,40(sp)
    1240:	ec4e                	sd	s3,24(sp)
    1242:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1244:	02051493          	sll	s1,a0,0x20
    1248:	9081                	srl	s1,s1,0x20
    124a:	04bd                	add	s1,s1,15
    124c:	8091                	srl	s1,s1,0x4
    124e:	0014899b          	addw	s3,s1,1
    1252:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1288:	d8c90913          	add	s2,s2,-628 # 2010 <freep>
  if(p == (char*)-1)
    128c:	5afd                	li	s5,-1
    ...
    129c:	df078793          	add	a5,a5,-528 # 2088 <base>
  ...
  if(p == (char*)-1)
    ...
    1306:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1308:	02071693          	sll	a3,a4,0x20
    130c:	01c6d713          	srl	a4,a3,0x1c
