...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	2fe50513          	add	a0,a0,766 # 1390 <malloc+0x108>
      9a:	00001097          	auipc	ra,0x1
      9e:	e0e080e7          	jalr	-498(ra) # ea8 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	2ee50513          	add	a0,a0,750 # 1390 <malloc+0x108>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	2dc50513          	add	a0,a0,732 # 1398 <malloc+0x110>
  ...
  chdir("/");
      ...
      e2:	2e250513          	add	a0,a0,738 # 13c0 <malloc+0x138>
      e6:	00001097          	auipc	ra,0x1
      ea:	dca080e7          	jalr	-566(ra) # eb0 <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	2e298993          	add	s3,s3,738 # 13d0 <malloc+0x148>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	2d098993          	add	s3,s3,720 # 13c8 <malloc+0x140>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	59c90913          	add	s2,s2,1436 # 16a0 <malloc+0x418>
    ...
    if(what == 1){
     ...
     116:	2c650513          	add	a0,a0,710 # 13d8 <malloc+0x150>
    ...
    int what = rand() % 23;
     ...
     174:	27850513          	add	a0,a0,632 # 13e8 <malloc+0x160>
     ...
     18e:	24e50513          	add	a0,a0,590 # 13d8 <malloc+0x150>
     ...
     1a0:	1f450513          	add	a0,a0,500 # 1390 <malloc+0x108>
     ...
     1fc:	21050513          	add	a0,a0,528 # 1408 <malloc+0x180>
     ...
     21e:	1fe50513          	add	a0,a0,510 # 1418 <malloc+0x190>
     ...
     28e:	1b650513          	add	a0,a0,438 # 1440 <malloc+0x1b8>
     ...
     2cc:	19850513          	add	a0,a0,408 # 1460 <malloc+0x1d8>
     ...
     2de:	18e50513          	add	a0,a0,398 # 1468 <malloc+0x1e0>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	bae080e7          	jalr	-1106(ra) # e90 <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	11658593          	add	a1,a1,278 # 1400 <malloc+0x178>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	17e50513          	add	a0,a0,382 # 1470 <malloc+0x1e8>
     ...
     308:	18450513          	add	a0,a0,388 # 1488 <malloc+0x200>
     30c:	00001097          	auipc	ra,0x1
     310:	b84080e7          	jalr	-1148(ra) # e90 <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	0f458593          	add	a1,a1,244 # 1408 <malloc+0x180>
     31c:	00001517          	auipc	a0,0x1
     320:	17c50513          	add	a0,a0,380 # 1498 <malloc+0x210>
     ...
     354:	15050513          	add	a0,a0,336 # 14a0 <malloc+0x218>
     ...
     3a2:	10250513          	add	a0,a0,258 # 14a0 <malloc+0x218>
     ...
     3b4:	a90080e7          	jalr	-1392(ra) # e40 <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	add	a0,a0,1915 # 177b <digits+0x23>
     ...
     402:	0c250513          	add	a0,a0,194 # 14c0 <malloc+0x238>
     ...
     42e:	08e50513          	add	a0,a0,142 # 14b8 <malloc+0x230>
     ...
     450:	05450513          	add	a0,a0,84 # 14a0 <malloc+0x218>
     ...
     46a:	06a50513          	add	a0,a0,106 # 14d0 <malloc+0x248>
     ...
     4b8:	fec50513          	add	a0,a0,-20 # 14a0 <malloc+0x218>
     ...
     514:	fd850513          	add	a0,a0,-40 # 14e8 <malloc+0x260>
     ...
     540:	fc458593          	add	a1,a1,-60 # 1500 <malloc+0x278>
     ...
     642:	e6250513          	add	a0,a0,-414 # 14a0 <malloc+0x218>
     ...
     65c:	ef850513          	add	a0,a0,-264 # 1550 <malloc+0x2c8>
     ...
     670:	ee450513          	add	a0,a0,-284 # 1550 <malloc+0x2c8>
     ...
     688:	e7c58593          	add	a1,a1,-388 # 1500 <malloc+0x278>
     ...
     6ce:	e8650513          	add	a0,a0,-378 # 1550 <malloc+0x2c8>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	7be080e7          	jalr	1982(ra) # e90 <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e7c50513          	add	a0,a0,-388 # 1558 <malloc+0x2d0>
     ...
     6fa:	e7a50513          	add	a0,a0,-390 # 1570 <malloc+0x2e8>
     ...
     714:	e7850513          	add	a0,a0,-392 # 1588 <malloc+0x300>
     ...
     730:	e7450513          	add	a0,a0,-396 # 15a0 <malloc+0x318>
     ...
     74a:	e8250513          	add	a0,a0,-382 # 15c8 <malloc+0x340>
     ...
     832:	e3a58593          	add	a1,a1,-454 # 1668 <malloc+0x3e0>
     ...
     856:	e1e50513          	add	a0,a0,-482 # 1670 <malloc+0x3e8>
     ...
     870:	c7c58593          	add	a1,a1,-900 # 14e8 <malloc+0x260>
     874:	4509                	li	a0,2
     ...
     88c:	c6058593          	add	a1,a1,-928 # 14e8 <malloc+0x260>
     890:	4509                	li	a0,2
     ...
     8e8:	d0c58593          	add	a1,a1,-756 # 15f0 <malloc+0x368>
     8ec:	4509                	li	a0,2
     ...
     95c:	b4858593          	add	a1,a1,-1208 # 14a0 <malloc+0x218>
     960:	4509                	li	a0,2
     ...
     9a8:	c4c58593          	add	a1,a1,-948 # 15f0 <malloc+0x368>
     9ac:	4509                	li	a0,2
     ...
     9ec:	c0858593          	add	a1,a1,-1016 # 15f0 <malloc+0x368>
     9f0:	4509                	li	a0,2
     ...
     a54:	a5058593          	add	a1,a1,-1456 # 14a0 <malloc+0x218>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	a4450513          	add	a0,a0,-1468 # 14b8 <malloc+0x230>
     a7c:	00000097          	auipc	ra,0x0
     a80:	414080e7          	jalr	1044(ra) # e90 <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	9e450513          	add	a0,a0,-1564 # 1468 <malloc+0x1e0>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aca:	9da50513          	add	a0,a0,-1574 # 14a0 <malloc+0x218>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     afa:	629c                	ld	a5,0(a3)
     afc:	6709                	lui	a4,0x2
     afe:	c0970713          	add	a4,a4,-1015 # 1c09 <digits+0x4b1>
    ...
    printf("grind: fork failed\n");
     ...
     b14:	99050513          	add	a0,a0,-1648 # 14a0 <malloc+0x218>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f4c:	81050513          	add	a0,a0,-2032 # 1758 <digits>
     f50:	883a                	mv	a6,a4
     f52:	2705                	addw	a4,a4,1
     f54:	02c5f7bb          	remuw	a5,a1,a2
     f58:	1782                	sll	a5,a5,0x20
     f5a:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    10de:	67eb8b93          	add	s7,s7,1662 # 1758 <digits>
    10e2:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10f6:	0992                	sll	s3,s3,0x4
    10f8:	397d                	addw	s2,s2,-1
    ...
    1134:	56890913          	add	s2,s2,1384 # 1698 <malloc+0x410>
        while(*s != 0){
    1138:	02800593          	li	a1,40
    113c:	bff1                	j	1118 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    113e:	008b8913          	add	s2,s7,8
...
{
    11a2:	715d                	add	sp,sp,-80
    11a4:	ec06                	sd	ra,24(sp)
    11a6:	e822                	sd	s0,16(sp)
    11a8:	1000                	add	s0,sp,32
...
{
    11d0:	711d                	add	sp,sp,-96
    11d2:	ec06                	sd	ra,24(sp)
    11d4:	e822                	sd	s0,16(sp)
    11d6:	1000                	add	s0,sp,32
...
free(void *ap)
{
    1206:	1141                	add	sp,sp,-16
    1208:	e422                	sd	s0,8(sp)
    120a:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    120c:	ff050693          	add	a3,a0,-16
    ...
    123c:	00e6ea63          	bltu	a3,a4,1250 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    1256:	02059813          	sll	a6,a1,0x20
    125a:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    126a:	02061593          	sll	a1,a2,0x20
    126e:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    1288:	7139                	add	sp,sp,-64
    128a:	fc06                	sd	ra,56(sp)
    128c:	f822                	sd	s0,48(sp)
    128e:	f426                	sd	s1,40(sp)
    1290:	ec4e                	sd	s3,24(sp)
    1292:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1294:	02051493          	sll	s1,a0,0x20
    1298:	9081                	srl	s1,s1,0x20
    129a:	04bd                	add	s1,s1,15
    129c:	8091                	srl	s1,s1,0x4
    129e:	0014899b          	addw	s3,s1,1
    12a2:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d8:	d3c90913          	add	s2,s2,-708 # 2010 <freep>
  if(p == (char*)-1)
    12dc:	5afd                	li	s5,-1
    ...
    12ec:	12078793          	add	a5,a5,288 # 2408 <base>
  ...
  if(p == (char*)-1)
    ...
    1356:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1358:	02071693          	sll	a3,a4,0x20
    135c:	01c6d713          	srl	a4,a3,0x1c
