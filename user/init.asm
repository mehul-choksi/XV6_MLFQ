...
main(void)
{
  ...
  12:	8c250513          	add	a0,a0,-1854 # 8d0 <malloc+0x10a>
  ...
  3a:	8a290913          	add	s2,s2,-1886 # 8d8 <malloc+0x112>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8be50513          	add	a0,a0,-1858 # 928 <malloc+0x162>
  ...
  8c:	84850513          	add	a0,a0,-1976 # 8d0 <malloc+0x10a>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	83650513          	add	a0,a0,-1994 # 8d0 <malloc+0x10a>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	84450513          	add	a0,a0,-1980 # 8f0 <malloc+0x12a>
  ...
  d2:	83a50513          	add	a0,a0,-1990 # 908 <malloc+0x142>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	83250513          	add	a0,a0,-1998 # 910 <malloc+0x14a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	52250513          	add	a0,a0,1314 # 9a8 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 590:	3c470713          	add	a4,a4,964 # 950 <malloc+0x18a>
 ...
 61c:	390b8b93          	add	s7,s7,912 # 9a8 <digits>
 ...
 672:	2da90913          	add	s2,s2,730 # 948 <malloc+0x182>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 82a:	7fa78793          	add	a5,a5,2042 # 1020 <base>
