...
00000000000001ec <main>:
{
 ...
 25e:	82658593          	add	a1,a1,-2010 # a80 <malloc+0x108>
 262:	4509                	li	a0,2
 ...
 294:	81050513          	add	a0,a0,-2032 # aa0 <malloc+0x128>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72e:	f9d9079b          	addw	a5,s2,-99
 732:	0ff7f713          	zext.b	a4,a5
 736:	12eb6163          	bltu	s6,a4,858 <vprintf+0x192>
 73a:	00271793          	sll	a5,a4,0x2
 73e:	00000717          	auipc	a4,0x0
 742:	38270713          	add	a4,a4,898 # ac0 <malloc+0x148>
 ...
 7ce:	34eb8b93          	add	s7,s7,846 # b18 <digits>
 ...
 824:	29890913          	add	s2,s2,664 # ab8 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 982:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 984:	02051493          	sll	s1,a0,0x20
 988:	9081                	srl	s1,s1,0x20
 98a:	04bd                	add	s1,s1,15
 98c:	8091                	srl	s1,s1,0x4
 98e:	0014899b          	addw	s3,s1,1
 992:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 9dc:	a3878793          	add	a5,a5,-1480 # 1410 <base>
