...
main(int argc, char *argv[])
{
  ...
  44:	81058593          	add	a1,a1,-2032 # 850 <malloc+0x108>
  48:	4509                	li	a0,2
  ...
  62:	80a58593          	add	a1,a1,-2038 # 868 <malloc+0x120>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40c:	4e050513          	add	a0,a0,1248 # 8e8 <digits>
 410:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50a:	00271793          	sll	a5,a4,0x2
 50e:	00000717          	auipc	a4,0x0
 512:	38270713          	add	a4,a4,898 # 890 <malloc+0x148>
 ...
 59e:	34eb8b93          	add	s7,s7,846 # 8e8 <digits>
 ...
 5f4:	29890913          	add	s2,s2,664 # 888 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 752:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 754:	02051493          	sll	s1,a0,0x20
 758:	9081                	srl	s1,s1,0x20
 75a:	04bd                	add	s1,s1,15
 75c:	8091                	srl	s1,s1,0x4
 75e:	0014899b          	addw	s3,s1,1
 ...
 7ac:	86878793          	add	a5,a5,-1944 # 1010 <base>
