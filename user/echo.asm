...
main(int argc, char *argv[])
{
  ...
  34:	830a8a93          	add	s5,s5,-2000 # 860 <malloc+0x104>
  ...
  76:	7f658593          	add	a1,a1,2038 # 868 <malloc+0x10c>
  7a:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5b2:	322b8b93          	add	s7,s7,802 # 8d0 <digits>
 ...
 608:	26c90913          	add	s2,s2,620 # 870 <malloc+0x114>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7c0:	85478793          	add	a5,a5,-1964 # 1010 <base>
