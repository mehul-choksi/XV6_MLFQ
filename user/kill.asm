...
main(int argc, char **argv)
{
  ...
  50:	7f458593          	add	a1,a1,2036 # 840 <malloc+0x10a>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	4c250513          	add	a0,a0,1218 # 8b8 <digits>
 3fe:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	36470713          	add	a4,a4,868 # 860 <malloc+0x12a>
 ...
 58c:	330b8b93          	add	s7,s7,816 # 8b8 <digits>
 ...
 5e2:	27a90913          	add	s2,s2,634 # 858 <malloc+0x122>
        while(*s != 0){
