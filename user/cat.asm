...
cat(int fd)
{
  ...
  44:	8b058593          	add	a1,a1,-1872 # 8f0 <malloc+0x100>
  48:	4509                	li	a0,2
  ...
  72:	89a58593          	add	a1,a1,-1894 # 908 <malloc+0x118>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 10a:	81a58593          	add	a1,a1,-2022 # 920 <malloc+0x130>
 10e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b4:	4e850513          	add	a0,a0,1256 # 998 <digits>
 4b8:	883a                	mv	a6,a4
 4ba:	2705                	addw	a4,a4,1
 4bc:	02c5f7bb          	remuw	a5,a1,a2
 4c0:	1782                	sll	a5,a5,0x20
 4c2:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 646:	356b8b93          	add	s7,s7,854 # 998 <digits>
 ...
 69c:	2a090913          	add	s2,s2,672 # 938 <malloc+0x148>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7fa:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7fc:	02051493          	sll	s1,a0,0x20
 800:	9081                	srl	s1,s1,0x20
 802:	04bd                	add	s1,s1,15
 804:	8091                	srl	s1,s1,0x4
 806:	0014899b          	addw	s3,s1,1
 80a:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 840:	7c490913          	add	s2,s2,1988 # 1000 <freep>
  if(p == (char*)-1)
 844:	5afd                	li	s5,-1
 ...
 854:	9c078793          	add	a5,a5,-1600 # 1210 <base>
